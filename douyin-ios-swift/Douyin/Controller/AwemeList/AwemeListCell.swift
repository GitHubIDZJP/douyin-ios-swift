...
class AwemeListCell: UITableViewCell {
    ...
    var share:UIImageView = UIImageView.init(image: UIImage.init(named: "icon_home_share")) //分享icon
    var comment:UIImageView = UIImageView.init(image: UIImage.init(named: "icon_home_comment"))//评论图标
