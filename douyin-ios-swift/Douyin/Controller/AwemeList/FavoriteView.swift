...
class FavoriteView:UIView {
    ...
    func initSubView() {
        ...
        favoriteBefore.isUserInteractionEnabled = true //默认为NO
        favoriteBefore.tag = LIKE_BEFORE_TAP_ACTION //1000
        //手势点击事件
        ...
        favoriteAfter.tag = LIKE_AFTER_TAP_ACTION //2000
        favoriteAfter.isHidden = true //点击之后的红色心默认先隐藏，可以再屏幕任意位置收拾点击，然后再显示出来 0.5秒后消失
